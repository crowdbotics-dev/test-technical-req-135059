"""
Django settings for test_technical_req_135059 project.
...
ROOT_URLCONF = 'test_technical_req_135059.urls'
...
WSGI_APPLICATION = 'test_technical_req_135059.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_technical_req_135059 API",
    "DESCRIPTION": "API documentation for test_technical_req_135059 App",
    "VERSION": "v1",
}
